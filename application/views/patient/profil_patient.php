...
<body>
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              ...
              <li class="elt-menu patients">
                <a href="#" title="resultat">resultats</a>
              </li> 
        ...
        <div class="shadow">
          ...
          <?php if ($users_profil->images) {?>
            <a href="<?= base_url().'patients/ProfilPages';?>">
              <img src="<?= base_url();?>assets/images/patient/<?= $users_profil->images;?>" style="height:80px; width:100px;" class="img-circle img-responsive" alt="">
            </a> 
          <?php } else {?>
            <a href="<?= base_url().'patients/ProfilPages';?>">
    ...
    <div class="container bootstrap snippet">
      <div class="row">
  		  <div class="col-sm-10"><h1><?= $users_profil->prenom_patient;?> <?= $users_profil->nom_patient;?></h1></div>
      </div>
      <div class="row">
  		  <div class="col-sm-3">
          <div class="text-center">
          <?php if($users_profil->images){?>
            <a href="#"><img src="<?= base_url();?>assets/images/patient/<?= $users_profil->images;?>" style="height:250px; width:400px;" class="avatar img-circle img-thumbnail" alt="avatar"></a>
            <?php } else{?>
              <a href="#"><img src="<?= base_url().'assets/images/defaut.png';?>" style="height:400px; width:400px;" class="avatar img-circle img-thumbnail" alt="avatar"></a>
            <?php }?>
          </div></hr><br>   
        </div>
    	  <div class="col-sm-9">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="infos">
              ...
              <form class="form" action="<?= base_url().'patients/UpdatePatient';?>" method="post" id="registrationForm">
                <div class="form-group">
                  <div class="col-xs-4">
                    <label for="name"><h4>Nom</h4></label>
                    <input type="text" class="form-control" name="nom" value="<?= $users_profil->nom_patient; ?>" placeholder="Nom " title="Nom">
                    <span style="color:red;"><?= form_error('nom');?></span>
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-xs-4">
                    <label for="name"><h4>Prenom</h4></label>
                    <input type="text" class="form-control" name="prenom" value="<?= $users_profil->prenom_patient; ?>" placeholder="Nom " title="Nom">
                ...
                <div class="form-group">
                  <div class="col-xs-4">
                    ...
                    <input type="email" class="form-control" name="email" value="<?= $users_profil->email;?>" placeholder="you@email.com" title="Email.">
                ...
                <div class="form-group">
                  <div class="col-xs-4">
                    ...
                    <input type="text" class="form-control" name="telephone" value="<?= $users_profil->telephone;?>" placeholder="Numéro" title="Telephone">
                    <span style="color:red;"><?= form_error('telephone');?></span>
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-xs-4">
                    <label for="phone"><h4>Personne a contacté</h4></label>
                    <input type="text" class="form-control" name="telephone2" value="<?= $users_profil->telephone2;?>" placeholder="Numéro" title="Telephone">
                ...
                <div class="form-group">
                  <div class="col-xs-4">
                    ...
                    <input type="text" class="form-control" name="pays"  value="<?= $users_profil->pays;?>" placeholder="Pays" title="Pays">
                ...
                <div class="form-group">
                  <div class="col-xs-4">
                    ...
                    <input type="text" class="form-control" name="ville"  value="<?= $users_profil->ville;?>" placeholder="Ville" title="Ville">
                    <span style="color:red;"><?= form_error('ville');?></span>
                  </div>
                </div><div class="form-group">
                  <div class="col-xs-4">
                    <label for="quartier"><h4>Quartier</h4></label>
                    <input type="text" class="form-control" name="quartier"  value="<?= $users_profil->quartier;?>" placeholder="Quartier" title="Quartier">
                ...
                <div class="form-group">
                  <div class="col-xs-4">
                    ...
                    <input type="text" class="form-control" name="sexe" id="sexe" value="<?= $users_profil->sexe;?>" placeholder="Sexe" title="Sexe">
                    <span style="color:red;"><?= form_error('sexe');?></span>
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-xs-4">
                    <label for="sexe"><h4>Groupe Sanguin</h4></label>
                    <input type="text" class="form-control" name="groupe_sanguin" id="sexe" value="<?= $users_profil->groupe_sanguin;?>" placeholder="Groupe Sanguin" title="Groupe Sanguin">
                    <span style="color:red;"><?= form_error('groupe_sanguin');?></span>
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-xs-4">
                    <label for="sexe"><h4>Rhésus</h4></label>
                    <input type="text" class="form-control" name="rhesus" id="sexe" value="<?= $users_profil->rhesus;?>" placeholder="Facteur Rhesus" title="Facteur Rhesus">
                    <span style="color:red;"><?= form_error('rhesus');?></span>
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-xs-4">
                    <label for="date"><h4>Date Naissance</h4></label>
                    <input type="date" class="form-control" name="date_naiss" id="date_naiss" value="<?= $users_profil->date_naissance;?>" placeholder="" title="date naissance">
                    <span style="color:red;"><?= form_error('date_naiss');?></span>
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-xs-12">
             ...
             <div class="tab-pane" id="security">
              ...
              <?php
                  ...
                  ?>
              <?php validation_errors();?>
              <form class="form" action="<?= base_url().'patients/UpdatePasswords';?>" method="post" id="registrationForm">
                <div class="form-group">
                  <div class="col-xs-6">
            ...
            <div class="tab-pane" id="profil">
              ...
              <?php
                  ...
                  ?>
              <?php validation_errors();?>
                <form action="<?= base_url().'patients/UploadImage';?>" method="post" enctype="multipart/form-data">
                  <?php if($users_profil->images){?>
                    <a href="#"><img src="<?= base_url();?>assets/images/patient/<?= $users_profil->images;?>" style="height:200px; width:200px; " class="image-preview__image" alt="avatar" id="preview-image" ></a>
                  <?php } else{?>
