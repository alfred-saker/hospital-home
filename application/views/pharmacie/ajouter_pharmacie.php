    ...
    <div class="container principal">
        <div class="row">
          ...
          <div class="shadow">
                ...
                <h3 class="titre-p-menu"><a href="<?= base_url().'Admin/';?>">Admin</a> / Ajouter une pharmacie</h3>
                <div class="text-right"><a href="<?= base_url().'Admin/listePharmacie';?>" class="btn btn-success" title="liste des pharmacies"><i class="glyphicon glyphicon-th-list"> </i> Liste Pharmacie </a></div>
    					</div>
              <div class="col-content-small post-element">
                ...
                <?php validation_errors();?>
							<form class="" method="post" action="<?= base_url().'Admin/ajouterPharmacie'?>" autocomplete="off">
								<div class="col-md-4">
                  <div class="form-group">
                    <label> Nom pharmacie</label>
                    <input type="text" class="form-control" autocomplete="off" placeholder="Entrer nom pharmacie........" name="nom">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label> Email</label>
                    <input type="email" class="form-control" autocomplete="off" placeholder="Entre votre email....." name="email">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" autocomplete="off" placeholder=" 6XX XX XX XX........ " name="telephone">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label> ville</label>
                    <input type="text" class="form-control" autocomplete="off" placeholder="Entrer la ville.... " name="ville">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" autocomplete="off" placeholder="Entrer le quartier.... " name="quartier">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" autocomplete="off" placeholder="Exemple: BP:17989" name="bp">
