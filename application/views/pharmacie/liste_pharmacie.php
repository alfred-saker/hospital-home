          ...
          <div class="col-md-12 cdg-left">
              ...
              <div class="col-content-small">
                <div class="col-content-elt info-profile">
                  <h4><a href="#">Bienvenue <span><?= $user_admin->nom;?></span></a> </h4>
                </div>
              </div>
          ...
          <span><em>Admin</em> </span>
            ...
            <div class="shadow">
              <div class="col-content-small post-element clearfix">
                ...
                <h3 class="titre-p-menu"><a href="<?= base_url().'Admin/';?>">Admin</a> - listing Pharmacie</h3>
                <div class="text-right"><a href="<?= base_url().'Admin/ajouterPharmacie';?>" class="btn btn-success" title="ajouter une pharmacie"><i class="glyphicon glyphicon-plus"> </i>Ajouter  </a></div>
              </div>
                  ...
                  <div class="table-responsive">
                    <table id="datatable" class="table table-striped table-bordered " cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?= $i;?></td>
                          <td><?= $donnee->nom_pharmacie;?></td>
                          <td><?= $donnee->email;?></td>
                          <td><?= $donnee->pays;?></td>
                          <td><?= $donnee->ville;?></td>
                          <td><?= $donnee->quartier;?></td>
                          <td><?= $donnee->telephone;?></td>
                          <td><?= $donnee->boite_postal;?></td>
                          <td><?= $donnee->date_creation;?></td>
                          <td>
                            <a style="cursor:pointer;" data-placement="top" data-toggle="tooltip" title="Suppimer" onclick="getIdPharmacie(
                                    '<?= $donnee->id_pharmacie;?>')">
                              <button class="btn btn-danger btn-xs" data-title="Suppimer" data-toggle="modal" data-target="#delete" >
                ...
                <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
                  <div class="modal-dialog">
                    ...
                    <div class="modal-footer ">
                      <form action="<?= base_url();?>admin/delete_pharmacie" method="post">
                        <input type="hidden" id="id_pharmacie" value="" name="id_pharmacie">
