...
<body>
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              <li class="elt-menu accueil">
                <a href="<?= base_url().'personnels/index';?>">Accueil</a>
              </li>
              <li class="elt-menu patients">
                <a href="<?= base_url().'personnels/verify';?>" title="Liste Patient">Patients</a>
              </li> 
    ...
    <div class="container bootstrap snippet">
      <div class="row">
  		  <div class="col-sm-10"><h1> <?= $donnees->nom_personnel;?></h1></div>
      </div>
      <div class="row">
  		  <div class="col-sm-3">
          <div class="text-center">
          <?php if($donnees->images){?>
            <a href="#"><img src="<?= base_url();?>assets/images/personnel/<?= $donnees->images;?>" style="height:250px; width:400px;" class="avatar img-circle img-thumbnail" alt="avatar"></a>
            <?php } else{?>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="infos">
              ...
              <form class="form" action="<?= base_url().'personnels/UpdatedataPersonnel';?>" method="post" id="registrationForm">
                <div class="form-group">
                  <div class="col-xs-6">
                    <label for="name"><h4>Nom</h4></label>
                    <input type="text" class="form-control" name="nom" value="<?= $donnees->nom_personnel; ?>" placeholder="Nom " title="Nom">
                ...
                <div class="form-group">
                  <div class="col-xs-6">
                    ...
                    <input type="text" class="form-control" name="telephone" value="<?= $donnees->telephone;?>" placeholder="Numéro" title="Telephone">
             ...
             <div class="tab-pane" id="security">
              ...
              <?php
                  ...
                  ?>
              <?php validation_errors();?>
              <form class="form" action="<?= base_url().'personnels/UpdatePassword';?>" method="post" id="registrationForm">
                <div class="form-group">
                  <div class="col-xs-6">
            ...
            <div class="tab-pane" id="profil">
              ...
              <?php
                  ...
                  ?>
              <?php validation_errors();?>
                <form action="<?= base_url().'personnels/UploadImage';?>" method="post" enctype="multipart/form-data">
                  <?php if($donnees->images){?>
                  <?php //var_dump($donnees);exit;?>
                    <a href="#"><img src="<?= base_url();?>assets/images/personnel/<?= $donnees->images;?>" style="height:200px; width:200px; " class="image-preview__image" alt="avatar" id="preview-image" ></a>
                  <?php } else{?>
