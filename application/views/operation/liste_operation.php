...
<body>
  ...
  <div class="col-lg-12 cdf-left">
    <div class="shadow">
      <h2 class="text-center">LISTING DES OPERATIONS JOURNALIERS</h2>
      <div class="container">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <form action="<?= base_url();?>personnels/download" method="post">
                  <input type="hidden" name="id_patient" value="<?= $param->id_patient;?>">
