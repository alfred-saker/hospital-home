...
<body>
        ...
        <div class="shadow">
          ...
          <div class="col-content-small">
            <div class="col-content-elt info-profile">
              <h4>
                <a href="#">Bienvenue <span><?= $user_admin->nom;?></span></a>
              </h4>
    ...
    <div class="container bootstrap snippet">
      <div class="row">
  		  <div class="col-sm-10"><h1> <?= $user_admin->nom;?></h1></div>
      </div>
      <div class="row">
  		  <div class="col-sm-3">
          <div class="text-center">
            <?php if($user_admin->images){?>
              <a href="#"><img src="<?= base_url();?>assets/images/super_admin/<?= $user_admin->images;?>" style="height:300px; width:500px;" class="avatar img-circle img-thumbnail" alt="avatar"></a>
            <?php } else{?>
            <a href="#"><img src="<?= base_url();?>assets/images/defaut.png" style="height:200px; width:300px;" class="avatar img-circle img-thumbnail" alt="avatar"></a>
            <?php }?>
          </div></hr><br>   
        </div>
    	  <div class="col-sm-9">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="infos">
              ...
              <form class="form" action="<?= base_url();?>admin/Updateadmin" method="post" id="registrationForm">
                <div class="form-group">
                  <div class="col-xs-6">
                    <label for="name"><h4>Nom</h4></label>
                    <input type="text" class="form-control" name="nom" value="<?= $user_admin->nom;?>" placeholder="Nom " title="Nom">
                ...
                <div class="form-group">
                  <div class="col-xs-6">
                    ...
                    <input type="email" class="form-control" name="email" value="<?= $user_admin->email;?>" placeholder="you@email.com" title="Email.">
                ...
                <div class="form-group">
                  <div class="col-xs-6">
                    ...
                    <input type="text" class="form-control" name="telephone" value="<?= $user_admin->telephone;?>" placeholder="Numéro" title="Telephone">
                    <span style="color:red;"><?= form_error('telephone');?></span>
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-xs-6">
                    <label for="username"><h4>Pays</h4></label>
                    <input type="text" class="form-control" id="pays" name="pays" value="<?= $user_admin->pays;?>"  placeholder="pays" title="pays">
                    <span style="color:red;"><?= form_error('pays');?></span>
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-xs-6">
                    <label for="adresse"><h4>Ville</h4></label>
                    <input type="text" class="form-control" name="ville" id="ville" value="<?= $user_admin->ville;?>" placeholder="Ville" title="Ville">
                    <span style="color:red;"><?= form_error('ville');?></span>
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-xs-6">
                    <label for="adresse"><h4>Quartier</h4></label>
                    <input type="text" class="form-control" name="quartier" id="quartier" value="<?= $user_admin->quartier;?>" placeholder="quartier" title="quartier">
                ...
                <div class="form-group">
                  <div class="col-xs-6">
                    ...
                    <input type="text" class="form-control" name="sexe" id="sexe" value="<?= $user_admin->sexe;?>" placeholder="Sexe" title="Sexe">
             ...
             <div class="tab-pane" id="security">
              ...
              <?php
                ...
                <?php }?>
              <?php validation_errors();?>
              <form class="form" action="<?= base_url().'admin/UpdatePassword';?>" method="post" id="registrationForm">
                <div class="form-group">
                  <div class="col-xs-6">
            ...
            <div class="tab-pane" id="profil">
              ...
              <?php validation_errors();?>
                <form action="<?= base_url();?>Admin/UpdateImage" method="post" enctype="multipart/form-data">
                  <?php if($user_admin->images){?>
                  <a href="#"><img src="<?= base_url();?>assets/images/super_admin/<?= $user_admin->images;?>" style="height:200px; width:200px; " class="image-preview__image" alt="avatar" id="preview-image" ></a>
                  <?php } else{?>
