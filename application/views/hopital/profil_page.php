...
<body>
            ...
            <ul class="nav nav-tabs">
              ...
              <?php if($rows->images){?>
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                  <img src="<?= base_url(); ?>assets/images/hopitaux/<?= $rows->images; ?>" style="height:50px; width:50px;" class="img-circle img-responsive" alt="">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              ...
              <li class="elt-menu patients">
                <a href="<?= base_url();?>Hopital/listePatients">Patients</a>
              </li>
      ...
      <div class="container principal">
        <div class="shadow">
          ...
          <?php if($rows->images){?>
            <a href="#">
              <img src="<?= base_url();?>assets/images/hopitaux/<?= $rows->images;?>" style="height:80px; width:80px;" class="img-circle img-responsive" alt="">
            </a>
          <?php } else {?>
            <a href="#">
          ...
          <div class="col-content-small">
            <div class="col-content-elt info-profile">
              <h4>
                <a href="#">Bienvenue <span>Admin <?= $rows->nom_hopital;?></span></a>
              </h4>
              <p><span>Hospital-Hostile-Home</span>
                	<span><?= $rows->pays;?></span>
                	<span><?= $rows->ville;?></span>
                	<span><?= $rows->quartier;?></span>
                	<span>En service à l’Hôpital <?= $rows->nom_hopital;?></span>
              </p>
            </div>
          </div>
    ...
    <div class="container bootstrap snippet">
      <div class="row">
  		  <div class="col-sm-10"><h1>Hôpital <?= $rows->nom_hopital;?></h1></div>
      </div>
      <div class="row">
  		  <div class="col-sm-3">
          <div class="text-center">
          <?php if($rows->images){?>
            <a href="#"><img src="<?= base_url(); ?>assets/images/hopitaux/<?= $rows->images;?>" style="height:250px; width:300px;" class="avatar img-circle img-thumbnail" alt="avatar"></a>
          <?php } else{?>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="infos">
              ...
              <form class="form" action="<?= base_url().'hopital/UpdateData';?>" method="post" id="registrationForm">
                <div class="form-group">
                  <div class="col-xs-6">
                    <label for="name"><h4>Nom</h4></label>
                    <input type="text" class="form-control" name="nom" value="<?= $rows->nom_hopital; ?>" placeholder="Nom " title="Nom">
                ...
                <div class="form-group">
                  <div class="col-xs-6">
                    ...
                    <input type="email" class="form-control" name="email" value="<?= $rows->email;?>" placeholder="you@email.com" title="Email.">
                ...
                <div class="form-group">
                  <div class="col-xs-6">
                    ...
                    <input type="text" class="form-control" name="telephone" value="<?= $rows->telephone;?>" placeholder="Numéro" title="Telephone">
                ...
                <div class="form-group">
                  <div class="col-xs-6">
                    ...
                    <input type="text" class="form-control" id="boite_postal" name="bp" value="<?= $rows->boite_postal;?>"  placeholder="BP:xxxx" title="Boite Postal">
                ...
                <div class="form-group">
                  <div class="col-xs-6">
                    ...
                    <input type="text" class="form-control" name="pays" id="pays" value="<?= $rows->pays;?>" placeholder="pays" title="pays">
                ...
                <div class="form-group">
                  <div class="col-xs-6">
                    ...
                    <input type="text" class="form-control" name="ville" id="ville" value="<?= $rows->ville;?>" placeholder="ville" title="ville">
                    <span style="color:red;"><?= form_error('ville');?></span>
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-xs-6">
                    <label><h4>Quartier</h4></label>
                    <input type="text" class="form-control" name="quartier" id="quartier" value="<?= $rows->quartier;?>" placeholder="quartier" title="quartier">
             ...
             <div class="tab-pane" id="security">
              ...
              <?php
                  ...
                  ?>
              <?php validation_errors();?>
              <form class="form" action="<?= base_url().'Hopital/UpdatePassword';?>" method="post" id="registrationForm">
                <div class="form-group">
                  <div class="col-xs-6">
            ...
            <div class="tab-pane" id="profil">
              ...
              <?php
                  ...
                  ?>
              <?php validation_errors();?>
                <form action="<?= base_url().'hopital/UploadImage';?>" method="post" enctype="multipart/form-data">
                  <?php if($rows->images){?>
                    <a href="#"><img src="<?= base_url(); ?>assets/images/hopitaux/<?= $rows->images;?>" style="height:250px; width:250px;" class="image-preview__image" alt="avatar" id="preview-image"></a>
                    <?php }else{?>
                  ...
                  <span  class="text-left"><strong style="color:red;">NB:Seuls les formats .jpg, .jpeg, .png, .gif, .png sont autorisés et cela jusqu'à une taille maximale de 2 Mo.</strong></span>
                  <div class="form-group">
                    <div class="col-xs-12">
                      <br>
                      <button  class="btn btn-lg btn-success btn-block" type="submit" ><i class="glyphicon glyphicon-ok-sign"></i> Enregister</button>
                    </div>
                  </div>
                  <script>
                    var _PREVIEW_URL;
