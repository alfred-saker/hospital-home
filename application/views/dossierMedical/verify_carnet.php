        ...
        <div class="col-md-12 cdg-left">
            ...
            <div>
              ...
              <div class="col-md-12 big-bloc-left" style="border:5px green solid; height:auto;">
                <h3 class="text-right"><a href="<?= base_url();?>operations/faireOperation/<?= $values->id_patient;?>" class="btn btn-success">Effectuer une operation</a></h3>
                <div class="col-md-12">
                ...
                <div class="col-md-4">
                  <strong>Personne à contacter:</strong> <span><?= $values->telephone2;?></span>
                </div>
                <div class="col-md-12">
              ...
              <?php foreach ($rend as $keys){?>
                <div class="col-md-12">
                  <h2 class="text-center"><strong><u> Examen du <?= $keys->date_operation;?> </u></strong></h2>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <strong>Dr <?= $keys->nom_personnel;?></strong></p>
                  <strong><?= $keys->nom_type_personnel;?> à l'hopital <?= $keys->nom_hopital;?>.</strong></p>
                </div>
                <?php } ?>
              </div>
