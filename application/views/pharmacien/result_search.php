          ...
          <div class="col-md-12 cdg-left">
            ...
            <div class="shadow">
              <div class="col-content-small post-element clearfix">
                ...
                <div class="text-right"><a href="<?= base_url().'pharmacie/ajouterPharmacien';?>" class="btn btn-primary" title="ajouter un pharmacien"><i class="glyphicon glyphicon-plus"></i><i class="glyphicon glyphicon-user"></i></a></div>
              </div>
                ...
                <?php
                  ...
                  <?php }?>
                    <div class="col-md-12 cdg-left">
                      <form class="form-inline form-search" action="<?= base_url();?>pharmacie/search/">
				                <div class="form-group">
					                <input type="search" class="form-control" id="inputsearch" placeholder="Medecin, hôpital, pharmacie, ...">
				                </div>
				                <button type="submit" style="width:10%;" class="btn btn-primary">Ok</button>
			                </form> <br>
                        <div class="table-responsive">
                          <table id="datatable" class="table table-striped table-bordered table-hover " cellspacing="0" width="100%">
                            ...
                            <?php $nbre++;?>
                              ...
                              <?php }} else {?>
                              <tr>
                                <td colspan="10"><strong>Aucun résultat trouvé!!</strong></td>
                              </tr>
                              <?php } ?>
                            </tbody>
                          </table>
